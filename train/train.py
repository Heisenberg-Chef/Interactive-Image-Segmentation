...
def train(args, net, optimizer, train_dataloaders, valid_dataloaders, lr_scheduler):
    ...
    print(f"max_epoch_num : {epoch_num}")
...
if __name__ == "__main__":
    ...
    dataset_dis = {"name": "jomoo",
                 "im_dir": "./data/jomoo/sum/imgs",
                 "gt_dir": "./data/jomoo/sum/gts",
                 "im_ext": ".jpg",
                 "gt_ext": ".png"}

    dataset_dis_val = {"name": "DIS5K-VD",
                 "im_dir": "./data/jomoo/sum_val/imgs",
                 "gt_dir": "./data/jomoo/sum_val/gts",
                 "im_ext": ".jpg",
                 "gt_ext": ".png"}
